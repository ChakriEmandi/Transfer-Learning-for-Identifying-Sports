...
- **Pre-trained Model:** Leverages Transfer Learning, significantly reducing training time while achieving 97% accuracy.
...
```
sports-classification-efficientnet/
│
├── sports-classification-efficientnet.ipynb   # Training: preprocessing, model building, training, evaluation
├── app.py                                     # Flask app to serve predictions
├── sports_model_efficient_net.h5              # Pre-trained EfficientNetB0 model
├── templates/
...
- Upload an image of a sport using the form.
...
- **Preprocessing:**  
  Images are resized to 224x224 and normalized using EfficientNet’s preprocessing pipeline.

- **Prediction:**  
  Outputs the most likely sports class with the associated probability.
